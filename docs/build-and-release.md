...
The current version is `0.9.22-alpha` (`overlay/package.json:3`).
...
With the current `name`/`version` (`realmshark-overlay` / `0.9.22-alpha`), the
installer is `overlay/dist/realmshark-overlay-0.9.22-alpha-setup.exe`.
